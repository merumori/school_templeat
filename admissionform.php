...
<head>
    ...
    <link href="css/admissin.css" rel="stylesheet">
</head>
<style>
...
@media (max-width: 768px) {
    ...
    .admission-form-card, .admission-form-image {
        width: 100%;
        max-width: 100%;
    }
    }
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
            <a href="index.php" class="navbar-brand">
                <h1 class="m-0 text-primary"><i class="fa fa-book-reader me-3"></i>ARJUN SCHOOL</h1>
            </a>
        ...
        <div class="container-xxl py-5 page-header position-relative mb-5">
            <div class="container py-5">
                <h1 class="display-2 text-white animated slideInDown mb-4">School Admission Form</h1>
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
c                        <li class="breadcrumb-item text-white active" aria-current="page">School Admission Form</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="admission-form-container">
            <div class="admission-form-card">
                <div class="card shadow-sm p-4">
                    <h2 class="text-center mb-4" style="color:#00ff55;">Admission Form</h2>

                    <form id="admission-form" action="admission.php" method="POST">
                        <div class="mb-3">
                            <label for="student-name" class="form-label">Student Full Name</label>
                            <input type="text" id="student-name" name="student-name" class="form-control" placeholder="Enter full name" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="parent-name" name="parent-name" class="form-control" placeholder="Enter parent name" required>
                        </div>
                        <button type="submit" class="btn w-100" style="background-color: #00ff55; color: black; font-weight: bold;">Submit Application</button>
                    </form>
                </div>
            </div>
            <div class="admission-form-image">
                <img src="img/addmission1.png" alt="Admission Image">
            </div>
        </div>
        <!-- Admission Form End -->
